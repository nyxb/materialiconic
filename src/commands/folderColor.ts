...
export async function changeFolderColor() {
   try {
...
function showQuickPickItems(currentColor: string) {
...
async function handleQuickPickActions(value: QuickPickItem) {
...
function validateColorInput(colorInput: string) {
