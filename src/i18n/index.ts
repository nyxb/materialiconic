...
async function getTranslationObject(language: string): Promise<Translation> {
 ...
 * */
export function getTranslationValue(key: string,
   translations = currentTranslation,
   fallback = fallbackTranslation): string | undefined {
   return (
 ...
 */
export function translate(key: string, ...variables: string[]): string {
 ...
 */
export function replace(value = '', ...variables: string[]) {
