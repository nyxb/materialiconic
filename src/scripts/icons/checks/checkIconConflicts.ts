...
function checkForConflictsInFileIcons(fileIconDefinitionType: 'fileExtensions' | 'fileNames') {
...
function handleErrors() {
   if (
      ...
      consolji.log('MaterialIconic:', red('Icon conflicts:'))
      consolji.log(red('--------------------------------------'))
...
function printErrorMessage(icons: any, definitionType: string) {
