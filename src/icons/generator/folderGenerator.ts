 ...
 */
export function loadFolderIconDefinitions(folderThemes: FolderTheme[],
 ...
 */
function setDefaultFolderIcons(theme: FolderTheme,
   config: IconConfiguration): IconConfiguration {
   config = merge({}, config)
 ...
 */
function getEnabledFolderTheme(themes: FolderTheme[],
   enabledTheme: string | undefined): FolderTheme | undefined {
 ...
 */
function disableIconsByPack(folderIcons: FolderTheme | undefined,
   activatedIconPack: string | undefined): FolderIcon[] {
   ...
   return folderIcons.icons.filter((icon) => {
      return !icon.enabledFor
         ...
         : icon.enabledFor.includes(activatedIconPack)
   })
}

function setIconDefinitions(config: IconConfiguration,
...
function createIconDefinitions(config: IconConfiguration,
   iconName: string,
   appendix = '') {
   config = merge({}, config)
...
function setFolderNames(iconName: string,
   folderNames: string[],
   appendix = '') {
...
function createDefaultIconConfigObject(hasFolderIcons: boolean,
   theme: FolderTheme,
   appendix = '') {
   const obj = {
      folder: '',
...
function createRootIconConfigObject(hasFolderIcons: boolean,
   theme: FolderTheme,
   appendix = '') {
   const obj = {
      rootFolder: '',
...
function getCustomIcons(folderAssociations: IconAssociations | undefined) {
...
export function generateFolderIcons(color: string | undefined) {
...
export function getPath(d: string, color: string) {
...
export function writeSVGFiles(iconName: string, svg: string) {
   let iconsPath
 ...
 */
export function validateHEXColorCode(color = '') {
